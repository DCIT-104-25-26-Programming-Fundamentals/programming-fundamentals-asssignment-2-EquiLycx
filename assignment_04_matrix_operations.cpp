...
void readMatrix(int matrix[MAX][MAX], int rows, int cols, const string& label);
void transposeMatrix(const int matrix[MAX][MAX], int transposed[MAX][MAX], int rows, int cols);
